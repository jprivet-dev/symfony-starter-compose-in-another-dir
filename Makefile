...
aliases: ## Auto generate aliases
	...
	@echo '#' >>$(ALIASES)
	@echo 'alias php="$(PHP)"' >>$(ALIASES)
	@echo 'alias composer="$(COMPOSER)"' >>$(ALIASES)
	@echo 'alias symfony="$(CONSOLE)"' >>$(ALIASES)
	@echo 'alias sf="symfony"' >>$(ALIASES)
